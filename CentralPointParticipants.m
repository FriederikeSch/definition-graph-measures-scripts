...
housecentralpointcounter=zeros(1,213);
for ii = 1:Number
    ...
    elseif exist(file)==2
        ...
        centralpointslist=find(maxdist==radius);
        
        
        for i=1:length(centralpointslist)
            hold=centralpointslist(1,i);
            housecentralpointcounter(1,hold)=housecentralpointcounter(1,hold)+1;
        end
        
      
   [sortedhousecentralpointlist(2,:),sortedhousecentralpointlist(1,:)]=sort(housecentralpointcounter);
